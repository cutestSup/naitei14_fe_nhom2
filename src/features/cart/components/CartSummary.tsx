  ...
  return (
    <div className="w-full max-w-md ml-auto mt-8">
      <div className="border border-gray-200 dark:border-gray-700">
        ...
        {/* VAT */}
        <div className="flex justify-between items-center p-4 border-b border-gray-200">
          <span className="text-gray-600 font-medium uppercase text-sm">{t("cart.vat").toUpperCase()}</span>
          <span className="text-gray-600 font-medium">
            {formatCurrency(vat)}
          </span>
        </div>
        ...
        <div className="flex justify-between items-center p-4 bg-green-primary text-white">
          <span className="font-bold uppercase text-sm">{t("cart.grandTotal").toUpperCase()}</span>
